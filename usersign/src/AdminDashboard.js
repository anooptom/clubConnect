...
const AdminDashboard = () => {
  ...
  const handleDelete = (e) => {
    ...
    axios
      .post(" http://localhost:3001/clubDelete", clubData)
      .then((response) => {
  ...
  const handleFSubmit = (e) => {
    e.preventDefault();
    axios
      .post(" http://localhost:3001/facultyCreate", FacultyData)
      .then((response) => {
  ...
  const handleFDSubmit = (e) => {
    e.preventDefault();
    axios
      .post(" http://localhost:3001/facultyDelete", FacultyDData)
      .then((response) => {
        if (response.data.message === "0") {
  ...
  const handleCreate = (e) => {
    ...
    axios
      .post(" http://localhost:3001/clubCreate", clubData)
      .then((response) => {
        if (response.data.message === "1") {
          alert("Success");
        } else if (response.data.message === "0") {
  ...
  const fetchfaculty = async () => {
    await fetch("http://localhost:3001/facultydisplay", {
      method: "get",
      mode: "cors",
    })
      .then((res) => res.json())
  ...
  const fetchclub = async () => {
    await fetch("http://localhost:3001/clubdisplay", {
      method: "get",
      mode: "cors",
    })
      .then((res) => res.json())
  ...
  const fetchuser = async () => {
    await fetch("http://localhost:3001/userdisplay", {
      method: "get",
      mode: "cors",
    })
      .then((res) => res.json())
        ...
        {selectedKey === "4" && (
          <div className="club-create">
            ...
            <form className="club-form" onSubmit={handleCreate}>
              ...
              <button className="club-create-button" type="submit">
                CREATE
              </button>
            </form>
          </div>
